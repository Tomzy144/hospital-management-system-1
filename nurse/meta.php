...
<!-------------------------------------------------------------------->
<link href="<?php echo $website_url?>/nurse/images/images/icon.png" rel="shortcut icon" type="image-png"/>

<link href="<?php echo $website_url?>/nurse/style/icons-1.10.2/font/bootstrap-icons.css" type="text/css" rel="stylesheet" >
